...
class Controller {
    ...
    init() {
        document.getElementById('add-btn').addEventListener('click', this.addItems);

        //Event: Remove an income item
        document.getElementById('income-list').addEventListener('click', this.removeIncomeItem);

        //Event: Remove an expense item
        document.getElementById('expenses-list').addEventListener('click', this.removeExpenseItem);
    ...
    removeIncomeItem(e) {
        ...
        UI.deleteBudgetItem(e.target)

        //remove item from store
        Store.removeBudgetItem(e.target.parentElement.id)
